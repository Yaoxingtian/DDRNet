...
class GZdata_add_ikea0124(BaseDataset):
    def __init__(self, 
                 root, 
                 list_path, 
                 num_samples=None, 
        ...
        super(GZdata_add_ikea0124, self).__init__(ignore_label, base_size,
        ...
        #                     9: ignore_label,
        # }
        # the last class must be 0, or it can not be run by: pre[mask],  2 will excceed the index 
        self.label_mapping = {
                            0: ignore_label, 
                            1: 1, 
                            100: 0,
    ...
    def __getitem__(self, index):
        ...
        path2 = self.root+"GZdata_add_ikea0124/"+item["label"]
